var title_muaban = document.querySelectorAll('.title_muaban');
for (let i = 0; i < title_muaban.length; i++) {
    title_muaban[i].innerHTML = sessionStorage.getItem('muaban_get_click');
}

var get_p = document.querySelector('.get_p');
get_p.innerHTML = sessionStorage.getItem('muaban_get_click');
var get_link_back = document.querySelector('.get_link_back');
get_link_back.innerHTML = sessionStorage.getItem('muaban_get_click');

var img_get_muaban = document.querySelectorAll('.muaban_new1 img');
var name_muaban = document.querySelectorAll('.muaban_get_tt');
var get_price = document.querySelectorAll('.get_price');
const data = (name, img, price) =>{
    for (let i = 0; i < name.length; i++){
        img_get_muaban[i].src = img[i];
        name_muaban[i].innerHTML = name[i];
        get_price[i].innerHTML = price[i];
    }
}
if (sessionStorage.getItem('muaban_get_click')=='Honda City') {
    function hondacity(){
        var name = ['Honda City 1.5 AT Top 2019, màu đen, có hỗ trợ góp bank','(Nam Định - Hà Nam) Honda City 2021 ngập tràn ưu đãi + hỗ trợ vay trả góp 85% + giao xe ngay, thủ tục nhanh chóng','Honda City 2021 tặng phụ kiện + bảo hiểm thân vỏ lên đến 40tr - hỗ trợ góp 85% lãi suất ưu đãi'];
        var img = ['../Img/hondacity/1.jpg', '../Img/hondacity/2.jpg','../Img/hondacity/3.jpg'];
        var price = ['998 triệu','1 tỉ 118 tr','800 triệu'];
        data(name, img, price);
    }
    hondacity();
}
if (sessionStorage.getItem('muaban_get_click')=='Honda CRV') {
    function hondaCRV(){
...
if(sessionStorage.getItem('muaban_get_click')=='Toyota Vios'){
    function TOYOTAVIOS() {
...
if(sessionStorage.getItem('muaban_get_click')=='Toyota Fortuner'){
...
if(sessionStorage.getItem('muaban_get_click')=='Ford Ranger'){
    function FordRanger() {
...
if(sessionStorage.getItem('muaban_get_click')=='Acura'){
    function Acura() {
...
if(sessionStorage.getItem('muaban_get_click')=='Audi'){
    function Audi() {
...
if(sessionStorage.getItem('muaban_get_click')=='BMW'){
    function BMW() {
...
if(sessionStorage.getItem('muaban_get_click')=='Chevrolet'){
    function Chevrolet() {
...
if(sessionStorage.getItem('muaban_get_click')=='Daewoo'){
    function Daewoo() {
...
if(sessionStorage.getItem('muaban_get_click')=='Dongfeng (DFM)'){
    function Dongfeng() {
...
if(sessionStorage.getItem('muaban_get_click')=='Honda'){
    function Honda() {
...
if(sessionStorage.getItem('muaban_get_click')=='Huyndai'){
    function Huyndai() {
...
if(sessionStorage.getItem('muaban_get_click')=='Isuzu'){
    function Isuzu() {
...
if(sessionStorage.getItem('muaban_get_click')=='Kia'){
    function Kia() {
...
if(sessionStorage.getItem('muaban_get_click')=='LandRover'){
    function LandRover() {
...
if(sessionStorage.getItem('muaban_get_click')=='BMW 320i'){
    function BMW320i() {
...
if(sessionStorage.getItem('muaban_get_click')=='Mercedes C200'){
...
if(sessionStorage.getItem('muaban_get_click')=='Mercedes C300'){
...
if(sessionStorage.getItem('muaban_get_click')=='Mercedes E200'){
...
if(sessionStorage.getItem('muaban_get_click')=='Lexus LX570'){
    function LexusLX570() {
...
if(sessionStorage.getItem('muaban_get_click')=='Lexus'){
    function lexus() {
...
if(sessionStorage.getItem('muaban_get_click')=='Mazda'){
    function Mazda() {
...
if(sessionStorage.getItem('muaban_get_click')=='Mercedes-Benz'){
...
if(sessionStorage.getItem('muaban_get_click')=='Mitsubishi'){
    function Mitsubishi() {
...
if(sessionStorage.getItem('muaban_get_click')=='Nissan'){
    function Nissan() {
...
if(sessionStorage.getItem('muaban_get_click')=='Peugeot'){
    function Peugeot() {
...
if(sessionStorage.getItem('muaban_get_click')=='Suzuki'){
    function Suzuki() {
...
if(sessionStorage.getItem('muaban_get_click')=='Toyota'){
    function Toyota() {
...
if(sessionStorage.getItem('muaban_get_click')=='VinFast'){
    function VinFast() {
...
if(sessionStorage.getItem('muaban_get_click')=='Volkswagen'){
    function Volkswagen() {
...
if(sessionStorage.getItem('muaban_get_click')=='Xe tải'){
    function XeTai() {
